...
export const HDropdownCheckboxItem = component$<DropdownCheckboxItemProps>(
  ({ disabled, onChange$, closeOnSelect = false, ...props }) => {
    ...
    useTask$(function reactiveUserChecked({ track }) {
      ...
      checkedSig.value = bindCheckedSig.value;
    });
